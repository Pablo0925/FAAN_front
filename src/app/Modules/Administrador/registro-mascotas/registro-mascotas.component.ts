...
export class RegistroMascotasComponent implements OnInit {
	...
	public saveAndUpdateRazaAnimal() {
		...
		// 	} else {
		// 		this.saveRazaAnimal(this.animal);
		// 	}
		// }
	}
	...
	public saveRazaAnimal(animal: Animal) {
		// try {
		// 	this.animal.estadoAnimal = 'A';
		// 	this.razaAnimalService.saveRazaAnimal(animal).subscribe((data) => {
		// 		if (data != null) {
	...
	public editRazaAnimal(animal: Animal) {
		this.errorUnique = '';
		this.animal = { ...animal };
