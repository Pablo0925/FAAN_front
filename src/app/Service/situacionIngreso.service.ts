...
export class SituacionIngresoService {
  ...
  public getAllRazaAnimal(page:number,size:number,sort:string): Observable<SituacionIngreso[]> {
  ...
  public saveSituacionIngreso(situacioningreso: SituacionIngreso):Observable<SituacionIngreso>{
    return this.http.post<SituacionIngreso>(environment.apiuriPublic+'/situacioningreso/save', situacioningreso);
  }
